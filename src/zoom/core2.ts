...
export default class Zoom2 {
    ...
    public zoomABI = ["function combine(bytes) external view returns (bytes, bytes, bytes)"];
     ...
     * 
     */
    public addMappingCountCall(_contract:any, _methodAndParams: any, _fullSig: any, sigs: any[]): Promise<string> {
    ...
    public _addResultReferenceCall(_contract:any, _methodAndParams: any, resultIndex: number, _fullSig: any, type: number): Promise<string> {
    ...
    public async runZoomCallAndFulfillPromises(ZoomContractInstance: any, reset: boolean = false, debugFn: Function | false = false) {
